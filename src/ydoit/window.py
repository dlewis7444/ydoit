...
class MainWindow(Adw.ApplicationWindow):
    ...
    def _on_entry_activated(self, row: object, trigger: str) -> None:
        from ydoit.entry_editor import EntryEditorPage
